...
export const crearUsuario = async (req, res) => {
    try {
        ...
        [nombre_user, email, contrasena, id_rol || 2]
    );
        ...
        return res.json({ id: resultado.insertId, nombre_user, email, contrasena, id_rol: id_rol || 2, clienteId});
...
export const actualizarUsuario = async(req, res) => {
    ...
    res.json({nombre_user, email, contrasena: nuevaContrasena, id_rol, id})
...
export const eliminarUsuario = async(req, res) => {
    try {
        ...
        if (clienteId) {
            ...
            INNER JOIN carrito c ON cr.id_carrito = c.idWHERE c.id_cliente = ?`, [clienteId]);
